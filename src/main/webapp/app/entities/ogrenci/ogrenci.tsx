  ...
  return (
    <div>
      <h2 id="ogrenci-heading" data-cy="OgrenciHeading">
        <Translate contentKey="ex02App.ogrenci.home.title">Ogrencis</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ex02App.ogrenci.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/ogrenci/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ex02App.ogrenci.home.createLabel">Create new Ogrenci</Translate>
          </Link>
        </div>
      </h2>
        ...
        {ogrenciList && ogrenciList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ex02App.ogrenci.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogrenci.adiSoyadi">Adi Soyadi</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogrenci.ogrNo">Ogr No</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogrenci.cinsiyeti">Cinsiyeti</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogrenci.dogumTarihi">Dogum Tarihi</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ex02App.ogrenci.home.notFound">No Ogrencis found</Translate>
            </div>
          )
        )}
      </div>
