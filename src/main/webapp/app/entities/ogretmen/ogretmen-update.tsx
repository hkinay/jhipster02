  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex02App.ogretmen.home.createOrEditLabel" data-cy="OgretmenCreateUpdateHeading">
            <Translate contentKey="ex02App.ogretmen.home.createOrEditLabel">Create or edit a Ogretmen</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex02App.ogretmen.adiSoyadi')}
                id="ogretmen-adiSoyadi"
                name="adiSoyadi"
                data-cy="adiSoyadi"
                type="text"
              />
              <ValidatedField label={translate('ex02App.ogretmen.brans')} id="ogretmen-brans" name="brans" data-cy="brans" type="select">
