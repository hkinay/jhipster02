  ...
  return (
    <div>
      <h2 id="ogretmen-heading" data-cy="OgretmenHeading">
        <Translate contentKey="ex02App.ogretmen.home.title">Ogretmen</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ex02App.ogretmen.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/ogretmen/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ex02App.ogretmen.home.createLabel">Create new Ogretmen</Translate>
          </Link>
        </div>
      </h2>
        ...
        {ogretmenList && ogretmenList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ex02App.ogretmen.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogretmen.adiSoyadi">Adi Soyadi</Translate>
                </th>
                <th>
                  <Translate contentKey="ex02App.ogretmen.brans">Brans</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {ogretmenList.map((ogretmen, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`ex02App.Brans.${ogretmen.brans}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ex02App.ogretmen.home.notFound">No Ogretmen found</Translate>
            </div>
          )
        )}
      </div>
